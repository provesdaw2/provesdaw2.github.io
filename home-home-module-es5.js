(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["home-home-module"], {
    ...
    "xNBF":
    /*!****************************************************!*\
      !*** ./src/app/services/random-numbers.service.ts ***!
      \****************************************************/

    /*! exports provided: RandomNumbersService */

    /***/
    function xNBF(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RandomNumbersService", function () {
        return RandomNumbersService;
      });
      /* harmony import */
      ...
      var RandomNumbersService = /*#__PURE__*/function () {
        function RandomNumbersService() {
          _classCallCheck(this, RandomNumbersService);

          this._maxNData = 1000;
          this._curNData = 0;
          this._randNumbers = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"]([]);
        }

        _createClass(RandomNumbersService, [{
          key: "maxNData",
          get: function get() {
          ...
          key: "getNewRandNumbers",
          value: function getNewRandNumbers() {
            var _this = this;
            ...
            this.randNumbers.pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["take"])(1)).subscribe(function (originalRandNumbers) {
              originalRandNumbers = originalRandNumbers.concat(newNumbers);
              console.log(originalRandNumbers);

              _this._randNumbers.next(originalRandNumbers);
            });
          }
        }]);
      ...
      RandomNumbersService.ctorParameters = function () {
        return [];
      };

      RandomNumbersService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    ...
    function zpKS(module, __webpack_exports__, __webpack_require__) {
      ...
      var _services_random_numbers_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ../services/random-numbers.service */
      "xNBF");

      var HomePage = /*#__PURE__*/function () {
        function HomePage(randNumService) {
          var _this2 = this;
          ...
          this.randNumService.randNumbers.subscribe(function (origianlRandNumbers) {
            _this2.randNumbers = origianlRandNumbers;
          });
        }

        _createClass(HomePage, [{
          key: "loadNewData",
          value: function loadNewData(event) {
            //Demanar al service noves dades (per exemple, el service ens les anirà passant de 20 en 20)
            this.randNumService.getNewRandNumbers(); //Aturar l'event d'Scroll
      ...
      HomePage.ctorParameters = function () {
        return [{
          type: _services_random_numbers_service__WEBPACK_IMPORTED_MODULE_4__["RandomNumbersService"]
        }];
      };
